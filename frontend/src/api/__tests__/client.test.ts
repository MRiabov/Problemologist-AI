...
describe('API Client', () => {
  ...
  it('fetchEpisodes calls the correct endpoint', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith('/episodes/', expect.any(Object));
  ...
  it('fetchSkills calls the correct endpoint', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith('/skills/', expect.any(Object));
  ...
  it('fetchEpisode calls the correct endpoint', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith('/episodes/1', expect.any(Object));
  ...
  it('runAgent sends correct POST request', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith('/agent/run', expect.objectContaining({
      method: 'POST',
  ...
  it('runSimulation sends correct POST request', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith('/simulation/run', expect.objectContaining({
      method: 'POST',
