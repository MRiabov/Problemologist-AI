import pytest
from build123d import Box, Part, Compound, Location
from shared.workbenches.injection_molding import analyze_im
...
def test_analyze_im_undercut():
    ...
    undercut_found = any("occluded" in v.lower() or "undercut" in v.lower() for v in result.violations)
...
def test_im_cost_calculation():
    ...
    from shared.workbenches.injection_molding import _calculate_im_cost
    context = {}
