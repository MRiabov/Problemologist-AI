...
def test_int_179_manual_at_mention_contract(page: Page):
    ...
    page.wait_for_timeout(2000)  # Give it a moment to validate
    ...
    try:
        expect(valid_mention).to_have_class(re.compile(r"text-primary"), timeout=30000)
    except AssertionError:
        # If still red, log the classes to see what it is
        cls = valid_mention.get_attribute("class")
        print(f"\nDEBUG: Mention class is: {cls}")
        raise
