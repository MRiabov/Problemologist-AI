...
def test_apply_control(genesis_backend):
    ...
    # Check if set_dofs_force or control_dofs_force was called with a numpy array containing 10.0
    # MagicMock will call control_dofs_force because it's checked first in _set_entity_dofs_force
    call_args = mock_entity.control_dofs_force.call_args or mock_entity.set_dofs_force.call_args
    assert call_args is not None, "Neither control_dofs_force nor set_dofs_force was called"
