...
async def test_benchmark_generation_e2e():
    ...
    with (patch("worker.generators.benchmark.graph.get_db", side_effect=mock_get_db_gen), 
         ...
         patch("worker.generators.benchmark.graph.Path.read_bytes", return_value=b"fake_bytes")):
