...
def test_apply_control(genesis_backend):
    ...
    # Check if correct force control method was called
    # In GenesisBackend, control_dofs_force is preferred if available
    call_args = (mock_entity.control_dofs_force.call_args
                 or mock_entity.set_dofs_force.call_args)
