...
def mock_worker():
    with patch("src.agent.nodes.engineer.WorkerClient") as mock:
        ...
        instance.execute_python.return_value = {"stdout": "hello", "stderr": "", "exit_code": 0}
        yield instance
...
async def test_engineer_node_all_fail(mock_llm, mock_worker):
    mock_worker.execute_python.return_value = {"stdout": "", "stderr": "Persistent Error", "exit_code": 1}
