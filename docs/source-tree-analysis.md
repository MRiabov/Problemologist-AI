...
| `skills/` | Runtime skill repository mounted into agent sessions | `build123d-cad-drafting-skill`, `electronics-engineering`, `manufacturing-knowledge`, `mechanical-engineering`, `runtime-script-contract`, `skill-creator`, `spec-editing-style-guide` |
