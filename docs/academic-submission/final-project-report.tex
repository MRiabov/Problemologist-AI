...
\begin{enumerate}
    \setcounter{enumi}{1}
    \item A green objective the object must
\end{enumerate}
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.98\linewidth]{appendix_render_collage.png}
\caption{Composite appendix render of the freestanding transfer mechanism, showing RGB, depth, and segmentation information in that order.}
