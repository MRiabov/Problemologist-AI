...
\title{Problemologist-AI: An Agentic Framework for Training and Evaluating LLM Models on Mechanical Engineering Tasks}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.98\linewidth]{agent_workflow.png}
\caption{Agent workflow graph with linear progression and reviewer loops back to the previous node.}
