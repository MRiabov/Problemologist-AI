...
- **Learn More**: See [Explanation: {Topic}](../explanation/%7Blink%7D) to understand why this works
- **Solve Problems**: Check [How-To: {Task}](../how-to/%7Blink%7D) for specific scenarios
- **Reference**: Refer to [{API/CLI}](../reference/%7Blink%7D) for all options
