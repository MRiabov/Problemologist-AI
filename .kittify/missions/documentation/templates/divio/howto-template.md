...
- **Tutorial**: New to this? Start with [Tutorial: {Topic}](../tutorials/%7Blink%7D)
- **Reference**: See [{API/CLI Reference}](../reference/%7Blink%7D) for all options
- **Explanation**: Understand why this works in [Explanation: {Topic}](../explanation/%7Blink%7D)
