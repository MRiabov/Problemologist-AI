...
2. `render_cad(...)` and `render_technical_drawing(...)` generate ephemeral manual preview evidence under `renders/current-episode/` for the active stage.
