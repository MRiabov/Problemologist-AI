...
5. A `precise_path_definition.yaml` file when the implementation needs a higher-resolution payload trajectory/contact proof; it refines the coarse `motion_forecast` rather than replacing it.
