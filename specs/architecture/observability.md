...
29. Validation preview backend selection (`validation_preview_backend_selected`) with requested physics backend, actual preview backend, and render purpose (`validation_static_preview`).

30. Validation preview render completion (`validation_preview_render_complete`) with preview backend, image count, elapsed render time, and artifact paths.
