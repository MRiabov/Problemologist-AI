...
- [x] Update prompt/config surfaces so `render_cad(..., orbit_pitch=..., orbit_yaw=..., rgb=..., depth=..., segmentation=...)` and `objectives_geometry()` are discoverable where live preview is needed.
