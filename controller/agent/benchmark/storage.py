...
class BenchmarkStorage:
    ...
    async def save_asset(
        ...
        mjcf: str,
        images: list[bytes],
        metadata: dict[str, Any],  # Note: Can represent EpisodeMetadata or custom JSON schema
        db: AsyncSession,
    ...
    async def _upload_string(
        self, bucket: str, key: str, content: str, content_type: str
    ):
        def _upload():
            self.s3.put_object(
                Bucket=bucket,
