...
- `floor_plate`: box centered at `[20, 0, 10]` with size `[200, 180, 20]`.
- `support_tower`: box centered at `[100, 0, 125]` with size `[80, 120, 210]` (sits on top of floor_plate at z=20).
- `raised_goal_shelf`: box centered at `[375, 0, 235]` with size `[150, 120, 30]`.
...
- Success if the moved object's center enters `goal_zone` without entering `shelf_support_clearance`.
...
- `ServoMotor_DS3218`: servo motor mounted to drive the lift carriage along `slide_z`.
