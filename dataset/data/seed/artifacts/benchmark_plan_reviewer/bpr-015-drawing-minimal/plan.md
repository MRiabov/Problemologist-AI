...
- The benchmark assumes zero environment attachments and zero benchmark-side DOFs, even though the farther-right chute and goal cradle stretch the freestanding layout near the build-zone edge.
