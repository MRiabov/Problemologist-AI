...
- `handoff_bridge`: static shelf centered at `[150, 0, 185]` with size `[90, 110, 20]`.
...
- Benchmark-owned motion must stay limited to one `slide_z` platform axis; no extra benchmark-side swing arms or gates are permitted.
