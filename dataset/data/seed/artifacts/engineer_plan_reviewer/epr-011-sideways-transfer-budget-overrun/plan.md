...
6. Keep motion limited to the single driven roller axis; do not add indexing slides or extra powered alignment stages.
...
| Hidden extra actuation sneaks into the final assembly metadata | Medium     | High   | Keep the mechanism limited to the single driven roller axis and reject any added indexing stage that is not justified in the plan |
