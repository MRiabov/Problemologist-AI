...
- [ ] Narrow the same moving-part path in `precise_path_definition.yaml` without changing the moving-part set
...
- [ ] Validate `build_zone` fit, gate clearance, and the staged `motion_forecast` / `precise_path_definition.yaml` endpoint contract
