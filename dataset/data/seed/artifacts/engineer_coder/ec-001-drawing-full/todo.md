...
- [ ] Read `benchmark_definition.yaml`, `benchmark_assembly_definition.yaml`, `plan.md`, `assembly_definition.yaml`, and `precise_path_definition.yaml`
...
- [ ] Validate the coarse `motion_forecast` and the narrowed `precise_path_definition.yaml` against the build-safe start and goal-contact finish
