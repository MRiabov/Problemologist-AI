...
def build():
    fixtures = Compound(
        children=[
            _make_box("left_start_deck", (20.0, 18.0, 4.0), (-29.0, 0.0, 2.0)),
            _make_box("right_goal_deck", (20.0, 18.0, 4.0), (29.0, 0.0, 2.0)),
            _make_box("bridge_reference_table", (8.0, 8.0, 18.0), (0.0, 0.0, 24.0)),
