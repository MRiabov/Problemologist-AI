"""Bridge crossing solution plan evidence.

The landing_pocket sits adjacent to the goal zone and receives the cube
as it exits the bridge_deck. The design ensures the cube settles into the
goal zone volume without the pocket geometry occupying the goal zone.
"""
