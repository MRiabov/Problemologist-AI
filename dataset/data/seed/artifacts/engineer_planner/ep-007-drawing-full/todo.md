...
- [x] Create ramp_surface - HDPE sloped surface guiding ball from spawn to goal zone
...
- [x] Create goal_funnel - HDPE narrowing funnel at ramp exit aligned to goal zone
...
- [x] Cost within budget: $48.25 / $100.00 planner target
- [x] Weight within budget: 720.5 g / 1800.0 g planner target
- [x] Submit for review
