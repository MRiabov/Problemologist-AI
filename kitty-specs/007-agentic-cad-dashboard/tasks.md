...
- [ ] T008: Implement `RunService` and `BenchmarkService` wrappers
- [ ] T009: specific "Runs List" Component (Home View) with pagination
...
- [ ] T012: Build "Log Stream" Component (Console-like view for generic logs)
- [ ] T013: Build "Structured Thought" Component (Collapsible steps for Thoughts/Tools)
- [ ] T014: Integrate Live Updates into Run Detail Page
- [ ] T015: Add "Status Badge" and real-time state indicators
...
- [ ] T018: Build "3D Scene" Component with OrbitControls, Grid, and Lights
- [ ] T019: Integrate 3D Viewer into "Run Detail" Tabs
- [ ] T020: Add "View Controls" (Wireframe, Auto-rotate, Reset View)
...
- [ ] T021: Build "Benchmark Creation Wizard" (Multi-step Form)
- [ ] T022: Implement "Plan -> Review -> Approve" Workflow UI
