...
- **Contract Testing**: `schemathesis` is used to verify compliance between host and container agents.
- **Scaling**: The architecture supports horizontal scaling to at least 4 concurrent containers on a single 4-core machine and is designed for future distribution across IPv6 nodes.
