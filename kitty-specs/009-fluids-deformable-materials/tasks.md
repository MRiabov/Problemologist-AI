...
**Goal**: Equip the agents with Python utility functions to reason about stress and fluids, and update their prompts for stress-aware design.
**Priority**: P2
**Estimated Prompt Size**: ~350 lines
**Subtasks**:
...
- [x] **T025**: Update benchmark planner to generate stress/fluid-based `benchmark_definition.yaml`.
